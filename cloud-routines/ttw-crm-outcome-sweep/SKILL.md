...
DELIVERY_MODE: TEST. Any message goes to the director's Slack DM, channel = DIRECTOR_SLACK_ID, via `slack_send_message` on that connector only. Never a second sender, never a team channel.
