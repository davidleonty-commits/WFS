...
4. **Delivery rules apply.** Any Slack output goes through the Lovable WFS Slack connector, routed to Caydo's DM while in test mode. The ledger is this skill's only write target; never touch the salesboard or any other resource doc.
